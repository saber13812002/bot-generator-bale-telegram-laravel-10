...
4. یک پست از کانال را در خصوصی فوروارد کن.
...
- [ ] `/start` مالک بدون کانال، فوروارد می‌خواهد.
- [ ] فوروارد گروه رد می‌شود.
- [ ] اگر ربات ادمین نباشد، پیام خطا می‌آید.
- [ ] بعد از ادمین شدن و فوروارد، پست تست در کانال ظاهر می‌شود.
