...
return [
    ...
    'mawkib_finder_verified_ok' => '✅ احراز هویت شما تأیید شد.',
    'mawkib_finder_select_province' => 'روز ورود شما به کدام استان است؟\n\nاستان مورد نظر را انتخاب کنید:',
    'mawkib_finder_results_header' => "📍 نتایج امروز — استان :province:\n",
    'mawkib_finder_city_line' => '🏙 :city: :count جای خالی',
    'mawkib_finder_today_result_hint' => "ℹ️ این نتیجه امروز است که برای شما ارسال شده.\n\nاگر روز ورود شما روز دیگری است، لطفاً تاریخ ورودتان به این استان را انتخاب کنید:",
    'mawkib_finder_select_entry_date' => '📅 تاریخ ورود خود را از بین ۱۴ روز آینده انتخاب کنید:',
    ...
    'mawkib_finder_final_results' => "📍 نتایج نهایی — استان :province:\n",
    'mawkib_finder_registration_link' => "🔗 برای ثبت‌نام در موکب از لینک زیر استفاده کنید:\n\n:url",
