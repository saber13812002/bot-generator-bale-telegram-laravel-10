...
Chat ID: :chat_id',
    ...
    'channel_poster_welcome_ready' => 'کانال بله وصل است. متن، عکس، صوت یا ویدیو بفرست تا بپرسم کجا ارسال شود. /cancel برای انصراف.',
    ...
    'channel_poster_bale_connected' => 'کانال بله وصل شد. یک پست تست آنجا گذاشتم؛ آن را پاک کن. از این به بعد مطلب بفرست تا به کانال ارسال شود.',
    'channel_poster_ask_destination' => 'این مطلب را کجا بفرستم؟',
    'channel_poster_btn_bale' => 'بله',
    'channel_poster_btn_all' => 'همه',
    'channel_poster_btn_add' => 'افزودن پلتفرم',
    'channel_poster_coming_soon' => 'تلگرام و ایتا به‌زودی اضافه می‌شوند. فعلاً می‌توانی به بله یا همه بفرستی.',
    'channel_poster_published' => 'مطلب در کانال ارسال شد.',
