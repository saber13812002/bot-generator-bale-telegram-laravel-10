...
Chat ID: :chat_id',
    ...
    'channel_poster_welcome_ready' => 'Channels are ready. Tags: :tags Send a post to publish. /add to add a channel or platform. /cancel to abort.',
    ...
    'channel_poster_bale_connected' => 'Bale channel connected. I posted a test message there; please delete it.',
    ...
    'channel_poster_btn_add' => 'Add destination',
    'channel_poster_btn_new_tag' => 'New tag',
    'channel_poster_coming_soon' => 'Add Telegram or Eitaa with /add.',
    'channel_poster_soroush_soon' => 'Soroush will be added soon.',
    'channel_poster_published' => 'Posted to tag ":tag" destinations.',
    ...
    // Quran Bot — reciters & search improvements (fallback for locales without keys)
    'search' => 'Search',
    'search prompt' => '🔍 Send the phrase you want to search for in the Quran.',
    'next page' => 'Next page',
    'surah number :sura' => 'Surah :sura',
    'ayah number :aya' => 'Ayah :aya',
    'n results found' => ':count results found.',
    'no results found' => 'No results found for your search.',
    'current reciter :reciter' => '🎧 Current reciter: :reciter',
    'select reciter' => 'Select reciter',
    'reciter not found' => 'That reciter was not found. Please choose one from the buttons.',
    'settings mp3 status' => 'Audio recitation',
    'your quran readings analysis report' => 'Your Quran readings analysis report',
    'send mp3 for selected reciter' => 'Send mp3 for the selected reciter',
