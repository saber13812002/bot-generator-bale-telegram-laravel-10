...
return [
    ...
    'reward_menu_hint' => '🎁 Complete any plan to get double free books + an auto-activated 100% discount code!',
    'milestone_teaser' => '🎁 Special reward: receive :target books and :bonus free books will be added to your plan and a 100% discount code will auto-activate!',
    'milestone_win' => "🎉 Well done! You've unlocked the special reward!\n\n✅ :target books received\n📚 :bonus free books added to your plan\n💰 A :discount IRR discount has been applied\n🎫 100% discount code: :code\n\nThe code auto-activated — from now on all books are free for you! 🚀",
    'currency' => 'IRR',
    'yes' => 'Yes',
    'no' => 'No',
