...
class PersonnelSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // یا اطلاعات نمونه برای تست را نگه دارید
        $personnelData = [
            // اطلاعات نمونه برای تست (می‌توانید حذف یا تغییر دهید)
            [
                'first_name' => 'علی',
                'last_name' => 'احمدی',
            ...
            // اطلاعات واقعی خود را اینجا اضافه کنید:
            // [
            //     'first_name' => 'نام واقعی',
            //     'last_name' => 'نام خانوادگی واقعی',
            //     'national_code' => 'کد ملی واقعی',
            //     'phone_number' => 'شماره موبایل واقعی',
            //     'rank' => 'سرباز صفر', // یا 'سرباز یک', 'سرباز دو', 'سرباز سه'
            // ],
        ];
