...
class LibraryPlanRequest extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Text::make('Milestone Target', 'subscription.reward_target')->nullable()->readonly()->exceptOnForms(),
            Text::make('Reward Bonus', 'subscription.reward_bonus')->nullable()->readonly()->exceptOnForms(),
            DateTime::make('Reward Granted At', 'subscription.reward_granted_at')->nullable()->readonly()->exceptOnForms(),
