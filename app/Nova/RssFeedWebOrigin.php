...
class RssFeedWebOrigin extends Resource
{
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\RssFeedWebOrigin>
     */
    public static $model = \App\Models\RssFeedWebOrigin::class;
