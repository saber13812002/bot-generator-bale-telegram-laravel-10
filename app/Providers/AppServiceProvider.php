...
use App\Repositories\NahjApiRepositoryImpl;
...
use App\Services\NahjApiServiceImpl;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(NahjApiRepository::class, NahjApiRepositoryImpl::class);
        ...
        $this->app->bind(NahjApiService::class, NahjApiServiceImpl::class);
