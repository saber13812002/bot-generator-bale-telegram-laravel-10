# Legacy README - Bot Generator Project

This is the **previous version** of the README file.  
The new, updated version is available at [`README.md`](README.md).
...
برای مشاهده نسخه جدید README به [`README.md`](README.md) مراجعه کنید.
